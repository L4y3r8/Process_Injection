...
int main(int argc, char **argv)
{
    ...
    while(Process32Next(hSnapshot_processes,&ProcessInformation)) {
        ...
        //hSnapshot_processes = (HANDLE)(*(FARPROC)(func[0]))(dfFlags_SNAPMODULE,ProcessInformation.th32ProcessID);
        hSnapshot_modules = (HANDLE)(*(FARPROC)(func[0]))(dfFlags_SNAPMODULE,ProcessInformation.th32ProcessID);
